...
<head>
    ...
    <style>
    :root {
        --primary-color:rgb(197, 90, 191);
        --secondary-color:rgba(255, 156, 222, 0.27);
    }
    ...
    .btn-login:hover {
        background-color:rgb(239, 132, 200);
    }

    .login-footer {
        text-align: center;
        padding: 1rem;
        background-color:rgb(239, 132, 228);
        border-top: 1px solidrgb(188, 42, 159);
    }
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-footer">
                <p class="mb-0 text-muted">© 2025 Helena. All rights reserved.</p>
            </div>
        </div>
    </div>
