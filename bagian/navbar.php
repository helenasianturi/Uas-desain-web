...
<nav class="bg-gradient-to-r from-light-600 to-light-700 shadow-lg sticky top-0 z-50">
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex-shrink-0 flex items-center">
                <a href="index.php?page=home" class="flex items-center space-x-2 group">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="h-8 w-8 text-white group-hover:text-light-200 transition-colors" fill="currentColor"
                        viewBox="0 0 24 24">
                        <g>
                            <path
                    ...
                    <span
                        class="text-2xl font-bold text-white group-hover:text-light-200 transition-colors">Kompaz</span>
                </a>
            </div>
            ...
            <div class="md:hidden flex items-center">
                <button id="mobile-menu-button"
                    class="text-white hover:text-light-200 focus:outline-none transition-colors">
    ...
    <!-- Mobile Menu -->
    <div id="mobile-menu" class="md:hidden hidden bg-light-700 px-4 pb-4">
        <div class="pt-2 pb-3 space-y-1">
            <a href="/portal-polmed/index.php?page=home"
                class="nav-link block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-light-600">Home</a>
        </div>
        <div class="mt-2">
            <form id="mobile-search-form" class="flex">
                ...
                <button type="submit" class="px-4 py-2 rounded-r-full bg-light-800 text-white hover:bg-light-900">
...
links.forEach(link => {
    ...
    if (linkPage === currentPage) {
        link.classList.add('bg-white/10', 'text-light-200');
        const underline = link.querySelector('span:last-child');
        if (underline) underline.classList.add('w-full');
    } else {
        link.classList.add('text-white', 'hover:text-light-200');
    }
});
