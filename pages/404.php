...
<body>
    <div class="container">
        ...
        <h2 class="error-message">Halaman Ini Tidak Tersedia</h2>
        <p class="error-description">Silakan kembali ke halaman sebelumnya <a href="?page=home" class="bloody">Balek kau</a>.</p>
